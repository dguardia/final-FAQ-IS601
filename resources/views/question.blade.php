    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-primary float-left" href="{{ route('tag.create', ['question_id'=> $question->id])}}">
                            Add tags
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        @forelse($question->tags as $tag)
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <a class="btn btn-primary float-right" href="{{ route('tag.show', ['question_id'=> $question->id,'tag_id' => $tag->id]) }}">
                                        View
                                    </a>
                                </div>
                            </div>
